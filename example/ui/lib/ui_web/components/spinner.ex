defmodule UiWeb.Components.Spinner do
  @moduledoc """
  The `UiWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `UiWeb.Components.Spinner` module enables developers to provide
