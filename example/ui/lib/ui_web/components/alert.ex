defmodule UiWeb.Components.Alert do
  @moduledoc """
  UiWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
