defmodule UiWeb.Components.Menu do
  @moduledoc """
  The `UiWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `UiWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import UiWeb.Components.Accordion, only: [accordion: 1]
  import UiWeb.Components.Button, only: [button_link: 1]
