defmodule UiWeb.Components.Tabs do
  @moduledoc """
  `UiWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import UiWeb.Components.Badge, only: [badge: 1]
