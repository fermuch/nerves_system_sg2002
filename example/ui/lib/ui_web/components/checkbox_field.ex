defmodule UiWeb.Components.CheckboxField do
  @moduledoc """
  UiWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
