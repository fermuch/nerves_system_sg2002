defmodule UiWeb.Components.Combobox do
  @moduledoc """
  The `UiWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
