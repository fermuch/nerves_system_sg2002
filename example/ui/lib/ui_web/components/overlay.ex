defmodule UiWeb.Components.Overlay do
  @moduledoc """
  The `UiWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `UiWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
