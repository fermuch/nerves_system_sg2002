defmodule UiWeb.Components.CheckboxCard do
  @moduledoc """
  The `UiWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
