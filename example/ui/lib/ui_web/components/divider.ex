defmodule UiWeb.Components.Divider do
  @moduledoc """
  The `UiWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `UiWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
