...
CVITEKCONFIG_SITE = $(NERVES_DEFCONFIG_DIR)/package/cvitekconfig/genconfig
...
else ifeq ($(BR2_PACKAGE_CVITEKCONFIG_BOARD_RECAMERA),y)
	CVITEKCONFIG_BOARD = recamera
endif
...
ifeq ($(BR2_PACKAGE_CVITEKCONFIG_PANEL_NONE),y)
	UBOOT_PANEL_TUNING_PARM=NONE
else ifeq ($(BR2_PACKAGE_CVITEKCONFIG_PANEL_ZCT2133V1),y)
